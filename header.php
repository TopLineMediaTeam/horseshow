	...
	<div class="header_main">
		...
		<div class="header_top_res">
			...
			<p>
				...
				<?php /*?><a href="<?php echo appthemes_get_feed_url(); ?>" class="srvicon rss-icon" target="_blank" title="<?php _e( 'RSS Feed', APP_TD ); ?>"><?php _e( 'RSS Feed', APP_TD ); ?></a><?php */?>
	...
	<div class="header_menu">
		...
		<div class="header_menu_res">
			...
			if(is_search())
				...
				wp_nav_menu( array( 'theme_location' => 'primary', 'menu_id' => 'menu-header', 'fallback_cb' => false, 'container' => false ) );

			 ?>



			<a href="<?php echo CP_ADD_NEW_URL; ?>" class="obtn btn_orange adButton"><?php _e( 'Post an Ad', APP_TD ); ?></a>
