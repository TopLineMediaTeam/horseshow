...
<div class="shadowblock_out slider_top">
			...
			<div class="shadowblockdir">
				...
				<h2 class="home_slider_f"><?php echo ucwords(strtolower($term->name)); ?></h2>
...
//echo $s_slug;
							...
							$actual_query=   "SELECT SQL_CALC_FOUND_ROWS  wp_posts.ID,wp_posts.post_title FROM wp_posts  INNER JOIN wp_term_relationships ON (wp_posts.ID = wp_term_relationships.object_id) INNER JOIN wp_postmeta ON ( wp_posts.ID = wp_postmeta.post_id ) 
...
//echo $wpdb->last_query;exit;
                            ...
                            <li style="height:260px; width:180px;">
								...
								?>
								<p><a href="<?php echo $permalink; ?>"><?php echo $pst->post_title; ?></a></p>
								
                                <p style="color:#020202;"><?php echo substr($pst->post_content,0,20); ?>..<a href="<?php echo $permalink; ?>" style="color:#0054a6; font-size:12px;">read more..</a></p>
