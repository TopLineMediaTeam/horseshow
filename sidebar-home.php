...
<div class="content_right">
	...
	<div class="tabprice">
		...
		<ul class="tabnavig">
            ...
            <li><a href="#priceblock4"><span class="big"><?php _e( 'Shows', APP_TD ); ?></span></a></li>
			<?php /*?><li><a href="#priceblock3"><span class="big"><?php _e( 'Poster', APP_TD ); ?></span></a></li><?php */?>
            <li><a href="#priceblock3"><span class="big"><?php _e( 'Seller', APP_TD ); ?></span></a></li>
		</ul>
        ...
        <div id="priceblock4">
            ...
            <p class="member-title"><?php _e( 'Information about the shows', APP_TD ); ?></p>
            <?php
            $id = get_the_ID();
$sql="SELECT horseshows.id as hsid,horseshows.city,horseshows.state,horseshows.image,horseshows.name_show,horseshows.show_date_time FROM horseshows LEFT JOIN horseshows_meta ON horseshows.id=horseshows_meta.show_id WHERE horseshows_meta.post_id='$id'";
                ...
                <div id="userphoto" style="float:left">
                    <p ><a href="<?php echo get_bloginfo( 'url' ); ?>/show-details/?id=<?php echo $det->hsid; ?>"><img class='image-thumb' src="<?php echo $det->image; ?>" width="100px" /></a></p>
                    
                </div>
                <ul class="member" style="float:left">
						
                        <li><span><a href="<?php echo get_bloginfo( 'url' ); ?>/show-details/?id=<?php echo $det->hsid; ?>"><?php if(!empty($det->hsid)){ echo $det->name_show; }?></a></span>
						</li>
						<li><span><?php if(!empty($det->hsid)){ echo $det->show_date_time; }?></span>
		...
		<div id="priceblock3">
			...
			<div class="postertab">
				...
				<div class="priceblocksmall dotted">
					...
					<?php /*?><p class="member-title"><?php _e( 'Information about the ad poster', APP_TD ); ?></p><?php */?>
                    <p class="member-title"><?php _e( 'Information about the seller', APP_TD ); ?></p>
