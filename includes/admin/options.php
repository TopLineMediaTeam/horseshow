			...
			<div class="wrap">
				...
				if ( isset($_POST['submitted']) ) {
					...
					$data = array(
						...
						'pack_horse_limit' => appthemes_clean($_POST['pack_horse_limit']),
						'pack_video_limit' => appthemes_clean($_POST['pack_video_limit']),
						'pack_imagelimit' => appthemes_clean($_POST['pack_imagelimit']),
						'pack_secure_mail' => appthemes_clean($_POST['pack_secure_mail']),
						'pack_social_media' => appthemes_clean($_POST['pack_social_media']),
						'pack_cancel' => appthemes_clean($_POST['pack_cancel']),
						'pack_ad_views' => appthemes_clean($_POST['pack_ad_views']),
						'pack_link_to_site' => appthemes_clean($_POST['pack_link_to_site']),
						'pack_iso_ad' => appthemes_clean($_POST['pack_iso_ad']),
					);
