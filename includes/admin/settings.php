		...
		$this->tab_sections['listings']['configuration'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'name' => 'form_val_lang',
					'extra' => array( 'size' => 5 ),
					'tip' => sprintf( __( 'This option allows you to set the language your ad submission form error messages are displayed in. Enter your two-letter country code (i.e. for German enter de). Not all languages have been translated but you can always add your own. To see the available languages, look in your %s folder.', APP_TD ), '/classipress/framework/js/validate/i18n' ),
				),
			),
		);
