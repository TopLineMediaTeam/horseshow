		...
		array(  'name' => __( 'Field Name', APP_TD ),
               ...
               array(   'name' => __( 'Field Type', APP_TD ),
                        ...
                        'options' => array( 'text box'  => __( 'text box', APP_TD ),
											...
											'multiple-drop-down' => __( 'multiple-drop-down', APP_TD ),
...
$options_new_membership_pack = array (
	...
	array(	'name' => __( 'Membership Pack Details', APP_TD ),
		...
		array(  'name' => __( 'Name', APP_TD ),
			   ...
			   array(  'name' => __( 'Limit of horse', APP_TD ),
                        'desc' => '',
                        'tip' => __( 'Enter the limit of horse', APP_TD ),
                        'id' => 'pack_horse_limit',
                        'css' => 'min-width:400px;',
                        'type' => 'text',
                        'vis' => '',
						...
						array(  'name' => __( 'Video Limit per ad', APP_TD ),
                        'desc' => '',
                        'tip' => __( 'Enter the limit of Video per ad', APP_TD ),
                        'id' => 'pack_video_limit',
                        'css' => 'min-width:400px;',
                        'type' => 'text',
                        'vis' => '',
                        ...
                        'min' => '1',
                        'std' => ''),
						array(  'name' => __( 'Images Limit per ad', APP_TD ),
                        'desc' => '',
                        'tip' => __( 'Enter the limit of Video per ad', APP_TD ),
                        'id' => 'pack_imagelimit',
                        'css' => 'min-width:400px;',
                        ...
                        'min' => '1',
                        'std' => ''),
						array(  'name' => __( 'Secure Email', APP_TD ),
                        'desc' => '',
                        'tip' => __( 'Please Select Yes or No', APP_TD ),
                        'id' => 'pack_secure_mail',
                        'css' => 'min-width:400px;',
                        'type' => 'select',
						...
						array(  'name' => __( 'Abilty to share Ad with Social Media', APP_TD ),
                        'desc' => '',
                        'tip' => __( 'Please Select Yes or No', APP_TD ),
                        'id' => 'pack_social_media',
                        'css' => 'min-width:400px;',
                        'type' => 'select',
                        'options' => array( '1'   => __( 'Yes', APP_TD ),
                                            '0' => __( 'No', APP_TD ), ),
                        ...
                        'min' => '',
                        'std' => ''),
						array(  'name' => __( 'Cancel Any Time', APP_TD ),
                        'desc' => '',
                        'tip' => __( 'Please Select Yes or No', APP_TD ),
                        'id' => 'pack_cancel',
                        'css' => 'min-width:400px;',
                        ...
                        'min' => '',
                        'std' => ''),
						array(  'name' => __( 'See # of Ad Views', APP_TD ),
                        'desc' => '',
                        'tip' => __( 'Please Select Yes or No', APP_TD ),
                        'id' => 'pack_ad_views',
                        'css' => 'min-width:400px;',
                        ...
                        'min' => '',
                        'std' => ''),
						array(  'name' => __( 'Link to your Website', APP_TD ),
                        'desc' => '',
                        'tip' => __( 'Please Select Yes or No', APP_TD ),
                        'id' => 'pack_link_to_site',
                        'css' => 'min-width:400px;',
                        'type' => 'select',
                        'options' => array( '1'   => __( 'Yes', APP_TD ),
                                            '0' => __( 'No', APP_TD ), ),
						...
						array(  'name' => __( 'Free ISO Ad', APP_TD ),
                        'desc' => '',
                        'tip' => __( 'Please Select Yes or No', APP_TD ),
                        'id' => 'pack_iso_ad',
                        'css' => 'min-width:400px;',
