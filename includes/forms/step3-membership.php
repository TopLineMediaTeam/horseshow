    ...
    <div class="shadowblock_out">
        <div class="shadowblock">
                ...
                <div class="thankyou">
                    ...
                    { 
                        ...
                        <ul class="membership-pack">
                            <li>
                                <strong><?php _e( 'Membership Pack:', APP_TD ); ?></strong> 
                                <?php echo stripslashes($order_processed['pack_name']); ?>
                            </li>
                            <li>
                                <strong><?php _e( 'Membership Expires:', APP_TD ); ?></strong> 
                                <?php echo appthemes_display_date($order_processed['updated_expires_date']); ?>
                            </li>
                        </ul>
            ...
            { ?>
                ...
                <div class="thankyou">
                    <p><?php _e( 'Your session or order has expired or we cannot cannot find your order in our systems. Please start over to create a valid membership order.', APP_TD ); ?>
                    </p>
                </div>
