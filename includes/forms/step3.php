...
?>
	...
	<div id="step3">
	<div class="post-head"><span class="add_new_heding"><?php if ( cp_payments_is_enabled() && $advals['cp_sys_total_ad_cost'] > 0 ) _e( 'Final Step', APP_TD ); else _e( 'Ad Listing Received', APP_TD ); ?></span></div>
	...
	{?>
    <!-- latestadblock -->
    <div id="latestadblock">
    
        <div class="clr"></div><br />
        <h1>Have you seen these horses for sale?</h1>
        <?php /*?><div class="undertab"><span class="big"><?php _e( 'Ads', APP_TD ); ?> / <strong><span class="colour"><?php _e( 'Have you seen these horses for sale', APP_TD ); ?></span></strong></span></div><?php */?>
    
        <?php /*?><?php query_posts( array( 'post_type' => APP_POST_TYPE, 'author' => $curauth->ID, 'paged' => $paged ) ); ?><?php */?>
...
<?php } else { ?>
	...
	<div class="post-head"><span class="add_new_heding"><?php _e( 'An Error Has Occurred', APP_TD ); ?></span></div>
