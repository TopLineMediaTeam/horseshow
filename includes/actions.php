...
?>
	<div class="price-wrap">
		<span class="tag-head">&nbsp;</span><p class="post-price"><?php if($cp_price_display_model=='Show Actual Price' || $cp_price_display_model==''){ cp_get_price( $post->ID, 'cp_price' );}else{ echo $current_list_price; } ?></p>
	</div>
